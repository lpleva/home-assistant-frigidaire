"""Value parsers for the details a Frigidaire appliance reports.

These turn raw reported values into something an entity can publish: normalising
alert shapes, rejecting placeholder readings, and telling "not supported by this
model" apart from "zero". They used to live in diagnostics.py, which is a reserved
platform filename in Home Assistant — that file is now the real diagnostics platform.
"""
